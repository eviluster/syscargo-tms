...
export class PrestatarioController {
  ...
  @Get(':id/perfil')
  @ApiOperation({
    summary: 'Obtener perfil completo del prestatario para cálculos de oferta',
    description: 'Retorna todos los datos del prestatario: cantidad de camiones, consumo de gasolina, tipos de vehículos, capacidad por tipo, disponibilidad y zona de cobertura'
  })
  async getPerfil(
    @Param(
      'id',
    ...
    return this.prestatarioService.getPerfil(id);
  }
}
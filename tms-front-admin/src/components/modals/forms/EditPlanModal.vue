    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header" id="kt_modal_edit_plan_header">
          <!--begin::Modal title-->
          <h2 class="fw-bold">Editar Plan</h2>
          <!--end::Modal title-->

          <!--begin::Close-->
          <div
            id="kt_modal_edit_plan_close"
        ...
        >
          ...
          <div class="modal-body py-10 px-lg-17">
            ...
            <div
              ...
              id="kt_modal_edit_plan_scroll"
              data-kt-scroll="true"
              data-kt-scroll-activate="{default: false, lg: true}"
              data-kt-scroll-max-height="auto"
              data-kt-scroll-dependencies="#kt_modal_edit_plan_header"
              data-kt-scroll-wrappers="#kt_modal_edit_plan_scroll"
...
export default defineComponent({
  ...
  setup(props) {
    ...
    watch(
      ...
      (newPlan) => {
        if (newPlan) {
          formData.value.name = newPlan.name || "";
          formData.value.descripcion = newPlan.descripcion || "";
        }
      },

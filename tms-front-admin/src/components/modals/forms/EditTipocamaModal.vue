  ...
  >
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
      ...
      <div class="modal-content">
        <!--begin::Modal header-->
        <div class="modal-header" id="kt_modal_edit_tipocama_header">
          <!--begin::Modal title-->
          <h2 class="fw-bold">Editar tipo de cama</h2>
          <!--end::Modal title-->

          <!--begin::Close-->
          <div
            id="kt_modal_edit_tipocama_close"
        ...
        >
          ...
          <div class="modal-body py-10 px-lg-17">
            ...
            <div
              ...
              id="kt_modal_edit_tipocama_scroll"
              data-kt-scroll="true"
              data-kt-scroll-activate="{default: false, lg: true}"
              data-kt-scroll-max-height="auto"
              data-kt-scroll-dependencies="#kt_modal_edit_tipocama_header"
              data-kt-scroll-wrappers="#kt_modal_edit_tipocama_scroll"
          ...
          <div class="modal-footer flex-center">
            ...
            <button
              type="reset"
              id="kt_modal_edit_tipocama_cancel"
...
export default defineComponent({
  ...
  setup(props) {
    ...
    watch(
      ...
      (newTipocama) => {
        if (newTipocama) {
          formData.value.name = newTipocama.name || "";
          formData.value.descripcion = newTipocama.descripcion || "";
        }
      },

  ...
  >
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
      ...
      <div class="modal-content">
        <!--begin::Modal header-->
        <div class="modal-header" id="kt_modal_edit_municipio_header">
          <!--begin::Modal title-->
          ...
          <!--begin::Close-->
          <div
            id="kt_modal_edit_municipio_close"
        ...
        >
          ...
          <div class="modal-body py-10 px-lg-17">
            ...
            <div
              ...
              id="kt_modal_edit_municipio_scroll"
              data-kt-scroll="true"
              data-kt-scroll-activate="{default: false, lg: true}"
              data-kt-scroll-max-height="auto"
              data-kt-scroll-dependencies="#kt_modal_edit_municipio_header"
              data-kt-scroll-wrappers="#kt_modal_edit_municipio_scroll"
              ...
              <div class="fv-row mb-7">
                ...
                <label class="fs-6 fw-semibold mb-2">
                  ...
                  <i
                    ...
                    title="Provincia must be active"
                  ></i>
                </label>
                <!--end::Label-->
          ...
          <div class="modal-footer flex-center">
            ...
            <button
              type="reset"
              id="kt_modal_edit_municipio_cancel"
...
export default defineComponent({
  ...
  setup(props) {
    ...
    watch(
      ...
      (newMunicipio) => {
        if (newMunicipio) {
          formData.value.name = newMunicipio.name || "";
          formData.value.provincia = newMunicipio.provincia || "";
        }
      },
    ...
    const rules = ref({
      ...
      provincia: [
        {
          required: true,
          message: "Customer provincia is required",
          trigger: "change",
        },
      ],
    });

        ...
        <div class="row mb-4">
          ...
          <div class="col-lg-8">
            <div v-if="!editing">
              ...
              <div v-if="prestatario?.licencia?.descripcion" class="text-muted mb-2">
                {{ prestatario.licencia.descripcion }}
              </div>
            ...
            <div v-else>
              ...
              <div class="mb-3">
                ...
                <textarea
                  v-model="draft.licencia.descripcion"
                  class="form-control form-control-solid"
                  rows="2"
          ...
          <div class="col-lg-8">
            <div v-if="!editing" class="row g-2">
              <div class="col-md-12 mb-3">
                <div class="text-muted fs-7">Precio por contenedor (según origen-destino)</div>
                <div class="d-flex align-items-center gap-2 mt-1">
                  <span class="fw-bold">{{ prestatario?.precioOrigen || '-' }}</span>
                  <span class="text-muted">→</span>
                  <span class="fw-bold">{{ prestatario?.precioDestino || '-' }}</span>
                  <span class="text-muted">:</span>
                  <span class="fw-bold">{{ formatPrecioTerrestreValor(precioTerrestreVistaPrestatario.precioTerrestrePorCargaContenedor) }}</span>
                </div>
              </div>
              <div class="col-md-6">
              ...
              <div class="col-md-4">
                <div class="text-muted fs-7">Origen → Destino</div>
                <div class="fw-bold fs-6">
                  {{ precioTerrestreVistaPrestatario.precioOrigen || '-' }} → {{ precioTerrestreVistaPrestatario.precioDestino || '-' }}
                </div>
                <div class="text-muted fs-7 mt-1">Ruta del contenedor</div>
              </div>
              <div class="col-md-4">
            ...
            <div v-else class="row g-2">
              <div class="col-md-12">
                <label class="form-label fs-7">Precio por contenedor (según origen-destino)</label>
              </div>
              <div class="col-md-3">
                <input
                  type="text"
                  v-model="draft.precioOrigen"
                  class="form-control form-control-solid"
              ...
              <div class="col-md-3">
                <input
                  type="text"
                  v-model="draft.precioDestino"
                  class="form-control form-control-solid"
                  placeholder="Destino (ej: Santiago)"
                />
              </div>
              <div class="col-md-3">
                <label class="form-label fs-7">Precio</label>
                <input
                  type="number"
...
export default defineComponent({
  ...
  setup() {
    ...
    const draft = reactive<any>({
      ...
      licencia: { numero: "", descripcion: "", categoria: "", vence: "" },
      ...
      precioOrigen: "" as string,
      precioDestino: "" as string,
    ...
    function mergePrecioTerrestreFromSource(src: any) {
      ...
      draft.precioOrigen = src.precioOrigen ?? src.precio_origen ?? "";
      draft.precioDestino = src.precioDestino ?? src.precio_destino ?? "";
      ...
      draft.precioOrigen = o.precioOrigen;
      draft.precioDestino = o.precioDestino;
    }
    ...
    function extractPrecioTerrestreFrom(src: any) {
      if (!src) {
        return {
          ...
          precioTerrestrePorCargaContenedor: null as number | null,
          precioTerrestrePorCargaGeneral: null as number | null,
          precioOrigen: null as string | null,
          precioDestino: null as string | null,
        };
      }
      ...
      return {
        ...
        precioOrigen: origen != null && origen !== "" ? String(origen) : null,
        precioDestino: destino != null && destino !== "" ? String(destino) : null,
      };
    }
    ...
    function populateDraftFromUser(src: any) {
      ...
      draft.licencia = {
        numero: s.licencia?.numero || "",
        descripcion: s.licencia?.descripcion || "",
        categoria: s.licencia?.categoria || "",
        vence: s.licencia?.vence || "",
      };
    ...
    function mergePrestatarioIntoDraft(p: any) {
      ...
      draft.licencia = {
        ...
        descripcion: p.licencia?.descripcion || "",
          ...
          const prestatarioPayload: any = {
            ...
            ...(serviciosIncluyeTerrestre(draft.servicios)
              ? {
                  ...
                  precioOrigen: draft.precioOrigen ?? null,
                  precioDestino: draft.precioDestino ?? null,
                }
              : {}),

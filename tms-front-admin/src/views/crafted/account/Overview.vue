    ...
    <div v-else style="width: 100%">
      <div class="row g-2">
        ...
        <div class="col-md-4">
          ...
          />
          <small class="text-muted d-block mt-1">
            Peso máximo de carga en kilogramos (kg)
          </small>
        </div>
        ...
        <div class="col-md-4">
          ...
          />
          <small class="text-muted d-block mt-1">
            Capacidad volumétrica en metros cúbicos (m³)
          </small>
        </div>
      </div>
    </div>
          ...
          <div class="col-lg-8">
            ...
            <div v-else>
              <div class="mb-3">
                ...
                <small class="text-muted d-block mt-1">Especifique la ruta y el precio para contenedores</small>
              </div>
              <div class="row g-2">
                <div class="col-md-6">
